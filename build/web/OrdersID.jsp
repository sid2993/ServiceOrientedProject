<%-- 
    Document   : OrdersID
    Created on : Nov 10, 2017, 1:05:21 AM
    Author     : Siddharth
--%>
...
<html>
	...
	java.util.List<webservices.OrderModel> result = port.getOrders1(cid);
    ...
    <%-- end web service invocation --%><hr/>
     ...
     <h6><a href="http://localhost:8080/Proj/OrdersIDForm.jsp">Back</a>      <a href="http://localhost:8080/Proj/Index.html">Home</a></h6>
    </body>
</html>
