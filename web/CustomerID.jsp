<%-- 
    Document   : CustomerID
    Created on : Nov 9, 2017, 8:55:09 PM
    Author     : Siddharth
--%>
...
<link rel="stylesheet" href="styles.css">
	...
	java.lang.String cid = request.getParameter("CustomerID");
	// TODO process result here
	java.util.List<webservices.CustomerModel> result = port.getCustomer1(cid);
